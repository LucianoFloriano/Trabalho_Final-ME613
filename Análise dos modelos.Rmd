...
metricas_modelo1 <- calcular_metricas(modelo1, dados, "Zana_1")
metricas_modelo2 <- calcular_metricas(modelo2, dados, "Zana_2")
metricas_modelo3 <- calcular_metricas(modelo3, dados, "Luciano_1")
metricas_modelo4 <- calcular_metricas(modelo4, dados, "Luciano_2")
